...
def distribute_data_to_clients(X, y, num_clients: int, min_samples: int = 5):
    ...
    print(f"[Data Distribution] {num_clients}개 클라이언트에 데이터 분배 완료")
